...
This repository manages the automated GitHub profile README workflow for jscraik.
...
- Non-standard build/typecheck commands: README regeneration uses npm run start.
